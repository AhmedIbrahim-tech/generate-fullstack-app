...
export function ForgotPasswordPage() {
  return (
    <main className="mx-auto flex min-h-[calc(100vh-80px)] max-w-md flex-col justify-center gap-4 px-6 py-12">
      <div>
      ...
      <div className="text-center text-xs text-zinc-500">
        <Link to="/login" className="font-semibold text-zinc-900 underline hover:text-zinc-700 dark:text-zinc-100">
          Back to Sign In
        </Link>
      </div>
    </main>
