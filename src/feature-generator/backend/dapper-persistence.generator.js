...
`;
  ...
  for (const usingLine of [usingA, usingB]) {
  ...
  content = content.replace(
    /static partial void RegisterGeneratedInfrastructure\(\s*IServiceCollection services,\s*IConfiguration configuration\)\s*\{/,
    `static partial void RegisterGeneratedInfrastructure(
        IServiceCollection services,
        IConfiguration configuration)
    {\n${registration}`,
